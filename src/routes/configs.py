...
def mcp_backend_config() -> ResponseReturnValue:
    return jsonify(
        {
            "success": True,
            "mviewer": {
...
def add_help_page(id, file_name) -> ResponseReturnValue:
    content = request.data
    if not content:
...
def add_app_extension(id, extension_id) -> ResponseReturnValue:
