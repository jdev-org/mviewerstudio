    ...
    return {
        ...
        actionVersionFormatter: (value, row, index) => {
            ...
            return `
                ...
                <a id="versionDeleteLink" class="d-none" onclick="mv.deleteVersion('${config.id }', '${ row.id}')"><span class="custom-tooltip-table"><i class="ri-delete-bin-2-line"></i><span>Supprimer cette version</span></span></a>
