    ...
    return {
        ...
        addBaseLayer: () => {
            let baseLayer = {
                ...
                fromcapacity: $('#formCustomBaseFromcapacity').prop('checked')=== true
            };
        ...
        validateFormBaseLayer: () => {
            ...
            // Reset input      
            document.querySelector('#formCustomBaseFromcapacity').checked = false;
        ...
        parseApplication(xml) {
            ...
            if (proxy) {
                optProxyUrl.value = proxy[0].getAttribute("url");
            }
        ...
        showListApplications(data, search) {
            ...
            if (!data.length) {
                searchBydescriptionInput.classList.add("d-none");
            } else {
                searchBydescriptionInput.classList.remove("d-none");
            }
            ...
            data
                ...
                .forEach((app) => {
                    ...
                    const navButtons = [{
                        ...
                        html: `
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-id="${ app.id }" data-url="${ app.url }" onclick="previewAppUrl(this.attributes[\'data-url\'].value)">Prévisualiser</a>
                            </li>`
                        }, {
