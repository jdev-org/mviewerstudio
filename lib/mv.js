var mv = (function () {
    ...
    return {
        ...
        showLayerOptions: function (el) {
            ...
            $("#frm-layer-showintoc").prop("checked", layer.showintoc == true ? false : true);
            ...
            data
                ...
                .forEach((app) => {
                    ...
                    const navButtons = [{
                        ...
                        html: `
                                <li class="nav-item">
                                    <a class="nav-link" href="#" data-url="${ _conf.mviewer_instance + (app.link || app.url) }" data-group="${ app.group }" onclick="loadApplicationParametersFromRemoteFile(this.attributes[\'data-url\'].value)">Modifier</a>
                                </li>`
                    }, {
